...
function emoj(owi){
  ...
  if(owi == "50d" || owi == "50n"){ return "<:foggyWeather:349532400872587265>"; } //This is a custom emoji, you would have to add your own
}
...
bot.on('message', (message) => {
  ...
  var weather = {
    ...
    exec: function(zip, message){
      var url = "http://api.openweathermap.org/data/2.5/weather?zip="+zip+"&APPID=<your free open weather api key>";
